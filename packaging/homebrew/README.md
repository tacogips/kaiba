...
- Formula: unsigned tarballs containing `bin/kaiba`.
...
```text
dist/homebrew/kaiba-<version>-darwin-arm64.tar.gz
dist/homebrew/kaiba-<version>-darwin-arm64.tar.gz.sha256
dist/homebrew/kaiba-<version>-darwin-x64.tar.gz
dist/homebrew/kaiba-<version>-darwin-x64.tar.gz.sha256
```
...
```bash
scripts/render-homebrew-formula.sh <version> ../homebrew-tap/Formula/kaiba.rb
```
...
dist/homebrew-cask/kaiba-<version>-darwin-arm64.dmg.sha256
dist/homebrew-cask/kaiba-<version>-darwin-x64.dmg
dist/homebrew-cask/kaiba-<version>-darwin-x64.dmg.sha256
```

Render the Cask:

```bash
scripts/render-homebrew-cask.sh <version> ../homebrew-tap/Casks/kaiba.rb
```
...
```bash
ruby -c Formula/kaiba.rb
brew audit --strict kaiba || brew audit --strict --formula kaiba
